    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <nav className="mb-8">
        <ol className="flex items-center space-x-2 text-sm text-text-muted">
          ...
          <li>
            <Link href={`/projects/${projectId}/media`} className="hover:text-text transition-colors">
              メディア一覧
            </Link>
          </li>
          <li>
      ...
      {/* Page Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-text mb-2">画像アップロード</h1>
      ...
      <div className="flex justify-between items-center">
        ...
        {uploadedFiles.length > 0 && (
          <button
            ...
            className="px-6 py-2 bg-accent text-white rounded-md hover:bg-accent-hover active:bg-accent-active transition-colors"
          >
            メディア一覧を確認
          </button>
        )}
