  ...
  if (error) {
    return (
      <div className={`text-center py-12 ${className}`}>
        ...
        <p className="text-text-muted mb-4">画像の読み込みに失敗しました</p>
        <TouchFeedbackButton
          onClick={() => refetch()}
          className="bg-accent hover:bg-accent-hover active:bg-accent-active text-white font-medium py-3 sm:py-2 px-4 rounded-md transition duration-200 touch-target"
          hapticType="light"
          visualFeedback={true}
        >
          再試行
      ...
      <div className={`text-center py-12 ${className}`}>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          <TouchFeedbackButton
            ...
            className="bg-accent hover:bg-accent-hover active:bg-accent-active text-white font-medium py-3 px-6 rounded-md transition duration-200 touch-target"
            hapticType="medium"
            visualFeedback={true}
          >
            画像をアップロード
          ...
          <Link
            ...
            className="text-accent hover:text-accent-hover font-medium py-3 px-6 rounded-md transition duration-200 touch-target touch-button border border-accent hover:border-accent-hover"
          >
            アップロードページを開く
          </Link>
        </div>
    ...
    <div className={className}>
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          <TouchFeedbackButton
            onClick={() => setShowUploadModal(true)}
            className="bg-accent hover:bg-accent-hover active:bg-accent-active text-white font-medium py-2 px-4 rounded-md transition duration-200 text-sm"
            hapticType="medium"
            visualFeedback={true}
          >
            + 画像を追加
          ...
          <Link
            href={`/projects/${projectId}/upload`}
            className="text-accent hover:text-accent-hover font-medium py-2 px-4 rounded-md transition duration-200 text-sm touch-button border border-accent hover:border-accent-hover"
          >
            アップロードページ
          </Link>
        </div>
      ...
      {/* Upload Modal */}
      {showUploadModal && (
        <div className="fixed inset-0 flex items-center justify-center p-4 z-50" style={{backgroundColor: 'var(--overlay)'}}>
            ...
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  ...
                  className="text-text-light hover:text-text-muted transition duration-200"
                >
